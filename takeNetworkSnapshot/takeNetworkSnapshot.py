...
try:
    configBackupRequested = getUserAnswer("Konfigurasyon yedegi alinsin mi? ")
    topologyRequested = getUserAnswer("Topoloji cikarilsin mi? ")
    if not configBackupRequested and not topologyRequested:
        writeToLogfile("BILGI: Ister yok. Iptal ediliyor...")
        os.abort()
